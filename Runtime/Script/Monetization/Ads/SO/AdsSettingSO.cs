...
namespace ProjectCore.Monetize
{
    public sealed class AdsSettingSO : ScriptableObject
    {
        ...
        [SerializeField] private List<CustomInterstitialConditionSO> _interstitialConditions;
        [BoxGroup("Interstitial")] 
        ...
        public IReadOnlyList<CustomInterstitialConditionSO> InterstitialConditions => _interstitialConditions;
